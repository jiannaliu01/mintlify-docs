...
<Update label="October 7, 2025">
  Added <code>end_page</code> as a parameter in the API.<br />
  Improved infrastructure significantly — memory handling is now much more efficient, allowing far more parallel runs.<br />
  Added <code>ephemeral</code> flag to prevent storage of images, signatures, barcodes, etc.
</Update>
